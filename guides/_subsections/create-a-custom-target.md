...
<ol>
  ...
  <li>
    ...
    <p>
      ...
      <figure>
        <a href="{{ site.url }}/images/4.2.0/custom-target-1.png" target="_blank">
          <img src="{{ site.url }}/images/4.2.0/custom-target-1.png">
        </a>
        <figcaption>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/topology-7.png"
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/custom-target-2.png"
  ...
  <li>
    {% capture test-custom-target-text %}
      <p>
        ...
        <figure>
          <a href="{{ site.url }}/images/4.2.0/custom-target-4.png" target="_blank">
            <img src="{{ site.url }}/images/4.2.0/custom-target-4.png">
          </a>
          <figcaption>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/custom-target-3.png"
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/custom-target-5.png"
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/custom-target-6.png"
