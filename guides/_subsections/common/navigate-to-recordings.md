{% capture navigate-to-recordings-include-text %}
  ...
  <a href="{{ site.url }}/images/4.2.0/navigate-to-recordings-2.png" target="_blank">
    <img src="{{ site.url }}/images/4.2.0/navigate-to-recordings-2.png">
  </a>
  {{ include.additional-content }}
{% endcapture %}
{% include howto_step.html
  summary="Navigate to <i>Flight Recorder/Capture/Recordings</i>"
  image-name="4.2.0/navigate-to-recordings-1.png"
  caption="
