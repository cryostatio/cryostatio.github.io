...
<ol>
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/targetjvmdetails-preview.png"
      caption="
  ...
  <li>
    <details>
        ...
        <div class="multi-image">
            <figure>
                <a href="{{ site.url }}/images/4.2.0/dashboard/targetjvmdetails-details.png" target="_blank">
                <img src="{{ site.url }}/images/4.2.0/dashboard/targetjvmdetails-details.png" alt="Details tab">
                </a>
                <figcaption><i>Details Tab</i></figcaption>
            </figure>
            <figure>
                <a href="{{ site.url }}/images/4.2.0/dashboard/targetjvmdetails-resources.png" target="_blank">
...
<ol>
  <li>
    ...
    <h4>Gallery view</h4>
        <figure>
            <a href="{{ site.url }}/images/4.2.0/dashboard/automatedanalysis-gallery.png" target="_blank">
                <img src="{{ site.url }}/images/4.2.0/dashboard/automatedanalysis-gallery.png" alt="Gallery view">
            </a>
        </figure>
        <p>
        ...
        <figure>
            <a href="{{ site.url }}/images/4.2.0/dashboard/automatedanalysis-result.png" target="_blank">
                <img src="{{ site.url }}/images/4.2.0/dashboard/automatedanalysis-result.png" alt="Automated Analysis Result">
            </a>
            <figcaption>
    ...
    <h4>List View</h4>
        <figure>
            <a href="{{ site.url }}/images/4.2.0/dashboard/automatedanalysis-list.png" target="_blank">
                <img src="{{ site.url }}/images/4.2.0/dashboard/automatedanalysis-list.png" alt="List view">
            </a>
        </figure>
        <p>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/automatedanalysis-preview.png"
      caption="
  ...
  {% capture automated-analysis-perform-text %}
    ...
    <p>
        <figure>
            <a href="{{ site.url }}/images/4.2.0/dashboard/automatedanalysis-noresult.png" target="_blank">
                <img src="{{ site.url }}/images/4.2.0/dashboard/automatedanalysis-noresult.png" alt="Perform analysis">
            </a>
        </figure>
    </p>
  {% endcapture %}
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/automatedanalysis-createrecording.png"
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/automatedanalysis-success.png"
...
<ol>
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/mbeanmetrics-preview.png"
  ...
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/mbeanmetrics-configuration.png"
  ...
  <li>
    ...
    {% include howto_step.html
      summary="Finish <code>Card</code> Creation"
      image-name="4.2.0/dashboard/mbeanmetrics.png"
...
<ol>
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/jfrmetrics-preview.png"
  ...
  <li>
    ...
    {% include howto_step.html
      summary="Finish <code>Card</code> Creation"
      image-name="4.2.0/dashboard/jfrmetrics-no-source.png"
  ...
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/jfrmetrics.png"
...
<ol>
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/dashboard/diagnostics-preview.png"
  ...
  <li>
    ...
    {% include howto_step.html
      summary="Finish <code>Card</code> Creation"
      image-name="4.2.0/dashboard/diagnostics.png"
...
<ol>
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-resize.png"
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-rearrange.png"
    ...
    <li>
        {% capture remove-card-text %}
            ...
            <figure>
                <a href="{{ site.url }}/images/4.2.0/dashboard/dashboard-cardremoved.png" target="_blank">
                    <img src="{{ site.url }}/images/4.2.0/dashboard/dashboard-cardremoved.png" alt="{{ Removed card }}">
                </a>
        ...
        image-name="4.2.0/dashboard/dashboard-cardkebab.png"
...
<ol>
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-blanklayout.png"
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-renamelayout.png"
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-deletelayout.png"
...
<ol>
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-layout-setastemplate.png"
...
<ol>
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-layoutselector-options.png"
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-templatepicker.png"
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-templatepicker-name.png"
    ...
    <li>
        ...
        image-name="4.2.0/dashboard/dashboard-layouttemplate.png"
