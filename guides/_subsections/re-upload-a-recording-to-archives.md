...
<ol>
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/re-upload-a-recording-to-archives-1.png"
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/re-upload-a-recording-to-archives-2.png"
      caption="
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/re-upload-a-recording-to-archives-3.png"
      caption="
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/re-upload-a-recording-to-archives-4.png"
