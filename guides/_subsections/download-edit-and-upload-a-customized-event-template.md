...
<ol>
  ...
  <li>
    ...
    <p>
      ...
      <a href="{{ site.url }}/images/4.2.0/navigate-to-events-2.png" target="_blank">
        <img src="{{ site.url }}/images/4.2.0/navigate-to-events-2.png">
      </a>
    </p>
    {% endcapture %}
    {% include howto_step.html
      summary="Navigate to Flight Recorder/Capture/Events"
      image-name="4.2.0/navigate-to-events-1.png"
      caption="
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/download-edit-and-upload-a-customized-event-template-1.png"
      caption="
  ...
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/download-edit-and-upload-a-customized-event-template-2.png"
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/download-edit-and-upload-a-customized-event-template-3.png"
      caption="
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/download-edit-and-upload-a-customized-event-template-4.png"
      caption="
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/download-edit-and-upload-a-customized-event-template-5.png"
      caption="
