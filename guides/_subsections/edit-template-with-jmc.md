...
<ol>
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/edit-template-with-jmc-1.png"
      caption="
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/edit-template-with-jmc-2.png"
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/edit-template-with-jmc-3.png"
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/edit-template-with-jmc-4.png"
      caption="
  ...
  <li>
    {% include howto_step.html
      ...
      image-name="4.2.0/edit-template-with-jmc-5.png"
      caption="
  ...
  <li>
    ...
    {% include howto_step.html
      ...
      image-name="4.2.0/edit-template-with-jmc-6.png"
      caption="
