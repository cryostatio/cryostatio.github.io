...
3. **Custom host/domain support**: there is a new `.spec.networkOptions.coreConfig.externalHost` CRD property available, which can be used to set a custom domain for the `Route` which the Operator creates for your Cryostat deployment.
